...
complete -c paw-zoom -l col-ruler -d 'Prepend a column-number ruler line above the magnified viewport (same shape as…'
complete -c paw-zoom -l border -d 'Wrap the rendered output in a light box-drawing frame (a \'|\' on each side of ev…'
